...
class InstagramService extends AbstractPlatformService
{
    protected function fetchComments(SocialConnection $connection, string $since): array|false
    {
        $response = $this->makeRequest(
            'get',
            "https://graph.facebook.com/v19.0/{$connection->platform_page_id}/media",
            $connection,
            ['fields' => 'comments{id,text,username,timestamp}', 'since' => $since],
        );
    ...
    /**
     * Instagram does NOT support hiding comments. This must never be called.
     */
